...
void InitEPwm2Example()
{
    ...
    EPwm2Regs.TBPHS.bit.TBPHS = 87;           // Phase is 0
...
{
    EPwm3Regs.TBPRD = 250;                        // Set timer period
    EPwm3Regs.TBPHS.bit.TBPHS = 170;            // Phase is 0
